...
public class MallGoodsCategoryController {
    ...
    @ResponseBody
    public Result save(@RequestBody GoodsCategory goodsCategory, HttpServletRequest request) {
        ...
        goodsCategory.setCreateUser((Integer) request.getSession().getAttribute("loginUserId"));
