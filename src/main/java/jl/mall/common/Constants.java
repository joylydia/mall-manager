...
//    public final static String FILE_UPLOAD_DIC = "/Users/joy/IdeaProjects/mall-manage/upload/";//上传文件的默认url前缀，根据部署设置自行修改
    public final static String FILE_UPLOAD_DIC = "/usr/mall/upload/";//上传文件的默认url前缀，根据部署设置自行修改
    ...
    public final static int SELL_STATUS_DELETE = 2;//商品删除状态
